#!/usr/bin/env bash
#
# update-plugin.sh — Automatically pull the latest @openchamber/opencode-cursor plugin
...
#
# The script:
#   1. Checks the latest `@openchamber/opencode-cursor` version on npm.
...
# ── Config ──────────────────────────────────────────────────────────────────
PLUGIN_NAME="@openchamber/opencode-cursor"
